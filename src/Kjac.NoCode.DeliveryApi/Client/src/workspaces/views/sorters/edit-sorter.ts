          ...
          <uui-form>
            <form name="form" id="form" @submit=${this.#onFormSubmit}>
              <uui-box>
                ...
                <small>The sorter name must be unique. It is used to auto-generate the sorter alias, which will be used for querying the Delivery API.</small>
                ...
                <small>
                  ...
                  Use a String field to perform alphanumeric sorting, if the property value is not expected to be a number or a date.
                </small>
                <umb-form-validation-message>
