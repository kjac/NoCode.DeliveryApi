(function () {
  ...
  function NoCodeDeliveryApiQueryController($scope, umbRequestHelper, overlayService, notificationsService, editorService, noCodeDeliveryApiResource) {
    ...
    function reload() {
      vm.loading = true;
      noCodeDeliveryApiResource.query.all().then(data => {
    ...
    function deleteFilter(filter, event) {
      deleteItem(
        'filter',
        event,
        () => noCodeDeliveryApiResource.query.deleteFilter(filter.key),
        () => {
    ...
    function deleteSort(sort, event) {
      deleteItem(
        'sorter',
        event,
        () => noCodeDeliveryApiResource.query.deleteSort(sort.key),
        () => {
